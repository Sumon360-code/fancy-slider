...
const createSlider = () => {
  ...
  if (duration >= 500) {
    ...
    alert('Slider change duration can not be less than .05 second!! please enter 500 milliseconds or more duration, otherwise you have to handle manually');
  }
}
...
searchBtn.addEventListener('click', function () {
  ...
  if(searchValue.match(letters)){
   ...
   alert("Please avoid unexpected input!");
  }
  sliders.length = 0;
});
